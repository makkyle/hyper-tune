...
tuner = BayesianOptimization(
    ...
    objective='val_accuracy',
    max_trials=200,  # Total number of trials
    num_initial_points=20,  # Number of initial random searches
    directory='my_dir',
    project_name='Bay_Optim_batch_32_mon'
)
...
# Define callback for threshold-based early stopping
...
log_dir = 'my_dir/Bay_Optim_batch_32_mon_TB'
